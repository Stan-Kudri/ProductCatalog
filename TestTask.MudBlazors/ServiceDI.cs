...
using TestTask.MudBlazors.DbContext;
...
namespace TestTask.MudBlazors
{
    public static class ServiceDI
    {
        ...
        public static void AppWebApplicationBuilder(this WebApplicationBuilder? builder)
        {
            ...
            builder.Services.AddSingleton(e => new FileDbContextFactory(ConnectionName));
            builder.Services.AddScoped(e => e.GetRequiredService<FileDbContextFactory>().Create());
